  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <main className="container mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-gray-600 dark:text-gray-400 mb-4 text-xl">
                Унікальний сервіс турботи про близьких — Ferma. Ми створили цей сервіс для
                обмеженого кола людей, які цінують якісні продукти харчування та прагнуть
                підтримувати своє здоров’я і здоров’я своїх рідних. Наші продукти надходять
                безпосередньо з фермерського господарства, розташованого в екологічно чистому
                регіоні України — Закарпатті, де дотримуються найвищих стандартів якості та чистоти.
                Це не просто магазин, а спільнота однодумців, які взяли на себе відповідальність
                піклуватися один про одного.
              </p>
              <p className="text-gray-600 dark:text-gray-400 text-xl">
                Ми не рекламуємо наш сервіс у соціальних мережах або через інші засоби масової
                комунікації, адже ферма має обмежені виробничі потужності. Зараз спільнота ще
                відкрита для нових учасників, але при досягненні 30 сімей прийом нових членів
                припиниться. Зважаючи на обмежену кількість учасників і високі стандарти якості, всі
                замовлення приймаються лише за умови 100% передплати. Замовлення потрібно робити до
                першої половини дня вівторка, що дозволяє нам ефективно планувати виробництво та
                доставку, гарантуючи стабільність і якість обслуговування кожного члена нашої
                спільноти.
              </p>
            </div>
            <img
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Галлерея</h2>
